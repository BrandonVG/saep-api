...
Producto.create([{ nombre: '', descripcion: '', precioPublico: '', precioMaquila:'', precioMayoreoPublico: '', precioMayoreoMaquila: '' },
                 ...
                 { nombre: 'Lona 13 onzas alta resolución', descripcion: 'Menos de 1/2 hasta 1/4 M2 el costo es 60% extra (.50 a .25)', precioPublico: '157', precioMaquila:'104', precioMayoreoPublico: '', precioMayoreoMaquila: '' } ])
